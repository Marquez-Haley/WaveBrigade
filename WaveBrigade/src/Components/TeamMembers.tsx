...
export default function TeamMembers(){
    ...
    return (
        <div className='flex flex-col items-center w-full mt-10' >
            <h4 className="text-3xl font-semibold mb-10" >Team 09 Members</h4>
            <div className="w-min flex space-x-6 mb-10">
                ...
                <div className="flex flex-col items-center space-y-2">
                    <a href="https://www.linkedin.com/in/sebas-andrade/" target="_blank" rel="noopener noreferrer">
                        <Avatar size="200" title="Sebastian Andrade" round={true} src={sebasPic} alt="Sebastian Andrade" />
                    </a>
                ...
                <div className="flex flex-col items-center space-y-2">
                    <a href="https://www.linkedin.com/in/haley-marquez/" target="_blank" rel="noopener noreferrer">
                        <Avatar size="200" name="Haley Marquez" round={true} src={haleyPic} alt="Haley Marquez" />
                    </a>
                ...
                <div className="flex flex-col items-center space-y-2">
                    <a href="http://www.linkedin.com/in/emanpelayo" target="_blank" rel="noopener noreferrer">
                        <Avatar size="200" title="Emanuelle Pelayo" round={true} src={whodis} alt="Emanuelle Pelayo"/>
                    </a>
            ...
            <h4 className="text-3xl font-semibold my-10">External Advisors</h4>
            <div className="w-min flex space-x-6 mb-10">
                <div className="flex flex-col items-center space-y-2">
                    <a href="https://www.linkedin.com/in/araamz/" target="_blank" rel="noopener noreferrer">
                        <Avatar size="200" title="Araam Zaremehrjardi" round={true} src={uncPic} alt="Araam Zaremehrjardi" />
                    </a>
                ...
                <div className="flex flex-col items-center space-y-2 mb-10">
                    <a href="https://www.linkedin.com/in/joannaclopez/" target="_blank" rel="noopener noreferrer">
                        <Avatar size="200" title="Joanna Lopez" round={true} src={joannaPic} alt="Joanna Lopez" />
                    </a>
                ...
                <div className="flex flex-col items-center space-y-2">
                    {/* https://www.unr.edu/journalism/faculty-and-staff/directory/crosswell-laura */}
                    <a href="https://www.unr.edu/journalism/faculty-and-staff/directory/crosswell-laura" target="_blank" rel="noopener noreferrer">
                        <Avatar size="200" title="Dr. Laura Crosswell" round={true} src={lauraPic} alt="Doctor Laura Crosswell"/>
                    </a>
            ...
            <h4 className="text-3xl font-semibold mb-10">Instructors</h4>
            <div className="w-min flex space-x-6 mb-10">
                <div className="flex flex-col items-center space-y-2">
                    <a href="https://www.unr.edu/cse/people/david-feil-seifer" target="_blank" rel="noopener noreferrer">
                        <Avatar size="200" title="David Feil-Seifer" round={true} src={davePic} alt="David Feil-Seifer" />
                    </a>
                ...
                <div className="flex flex-col items-center space-y-2">
                    <a href="https://www.linkedin.com/in/sara-r-davis-02b6b6190/" target="_blank" rel="noopener noreferrer">
                        <Avatar size="200" title="Sara Davis" round={true} src={saraPic} alt="Sara Davis" />
                    </a>
